#############################################################################
# Makefile for building: Remembrall
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  Remembrall.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Remembrall.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Remembrall1.0.0
DISTDIR = /run/media/eckaos/Stockage/ShareCode/Remembrall/.tmp/Remembrall1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: Remembrall.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Remembrall.pro
	$(QMAKE) -o Makefile Remembrall.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents agenda.hpp jsonFileList.hpp mainWidget.hpp task.hpp $(DISTDIR)/
	$(COPY_FILE) --parents agenda.cpp jsonFileList.cpp main.cpp mainWidget.cpp task.cpp $(DISTDIR)/
...
moc_mainWidget.cpp: mainWidget.hpp \
		agenda.hpp \
		task.hpp \
		jsonFileList.hpp \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /run/media/eckaos/Stockage/ShareCode/Remembrall/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/run/media/eckaos/Stockage/ShareCode/Remembrall -I/run/media/eckaos/Stockage/ShareCode/Remembrall -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/11.1.0 -I/usr/include/c++/11.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/11.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include-fixed -I/usr/include mainWidget.hpp -o moc_mainWidget.cpp
...
agenda.o: agenda.cpp agenda.hpp \
		task.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o agenda.o agenda.cpp

jsonFileList.o: jsonFileList.cpp jsonFileList.hpp \
		agenda.hpp \
		task.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o jsonFileList.o jsonFileList.cpp

main.o: main.cpp mainWidget.hpp \
		agenda.hpp \
		task.hpp \
		jsonFileList.hpp
