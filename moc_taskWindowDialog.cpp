/****************************************************************************
** Meta object code from reading C++ file 'taskWindowDialog.hpp'
**
...
#error "The header file 'taskWindowDialog.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 25, 24), // "onValidateButtonReleased"
QT_MOC_LITERAL(6, 50, 22) // "onCancelButtonReleased"

    },
    "TaskDialog\0validate\0\0s\0d\0"
...
void TaskDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->validate((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QDate(*)>(_a[2]))); break;
        ...
        {
            using _t = void (TaskDialog::*)(QString , QDate );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TaskDialog::validate)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TaskDialog::validate(QString _t1, QDate _t2)
{
